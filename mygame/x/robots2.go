...
func (g *Game) DrawFrame(screen *ebiten.Image) {
	...
	ebitenutil.DrawRect(screen, 0, 0, screenWidth, float64(frameThickness), frameColor)                                         // Top
	ebitenutil.DrawRect(screen, 0, screenHeight-float64(frameThickness), screenWidth, float64(frameThickness), frameColor)     // Bottom
	ebitenutil.DrawRect(screen, 0, 0, float64(frameThickness), screenHeight, frameColor)                                       // Left
	ebitenutil.DrawRect(screen, screenWidth-float64(frameThickness), 0, float64(frameThickness), screenHeight, frameColor)     // Right
}
